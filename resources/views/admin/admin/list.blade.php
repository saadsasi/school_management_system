...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>{{ __('messages.admin_list') }} ({{ __('messages.total') }} : {{ $getRecord->total() }})</h1>
          </div>
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <input type="text" class="form-control" value="{{ Request::get('email') }}" name="email" placeholder="{{ __('messages.email') }}">
                    </div>
                    <div class="form-group col-md-3">
