              ...
              <form method="get" action="">
                <div class="card-body">
                  ...
                  <div class="form-group col-md-4">
                    <label>  {{ __('messages.my_notice_title_field') }} </label>
                    <input type="text" class="form-control" value="{{ Request::get('title') }}" name="title"  placeholder="  {{ __('messages.my_notice_title_field') }}">
                  </div>
                  <div class="form-group col-md-4">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <a href="{{ url('parent/my_notice_board') }}" class="btn btn-success" style="margin-top: 30px;">  {{ __('messages.reset') }}</a>
                  </div>
