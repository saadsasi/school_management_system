                                ...
                                <div class="col-md-6">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @php
                                                                $passPercentage = ($exam->passed_students / $exam->total_students) * 100;
                                                            @endphp
                                            ...
                                            <div class="mt-4">
                                                <canvas id="chart-{{ str_replace(' ', '-', $exam->exam_name) }}" height="200"></canvas>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script>
    @if($reportType == 'analysis')
        @foreach($data as $exam)
            new Chart(document.getElementById('chart-{{ str_replace(' ', '-', $exam->exam_name) }}').getContext('2d'), {
                type: 'pie',
                data: {
                    labels: ['ناجح', 'راسب'],
                    datasets: [{
                        data: [{{ $exam->passed_students }}, {{ $exam->total_students - $exam->passed_students }}],
