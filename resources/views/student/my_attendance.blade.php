...
<div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>{{__('messages.my_attendance')}} <span style="color:blue"> ({{__('messages.total')}}: {{ $getRecord->total() }})</span> </h1>
          </div>
        </div>
      </div>
    </section>
         ...
         <div class="col-md-12">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">{{__('messages.search_my_attendance')}}</h3>
                </div>
                <form method="get" action="">
                  <div class="card-body">
                    ...
                    <div class="form-group col-md-2">
                      ...
                      <a href="{{ url('student/my_attendance') }}" class="btn btn-success" style="margin-top: 30px;">{{__('messages.reset')}}</a>
                    </div>
                    </div>
                  </div>
                </form>
